...
> This snapshot includes **LiteGUI-RL**, a low-cost MAI-UI-2B online GRPO
> extension built directly inside ClawGUI-RL. See
> [LITEGUI_RL_README_ZH.md](LITEGUI_RL_README_ZH.md).
