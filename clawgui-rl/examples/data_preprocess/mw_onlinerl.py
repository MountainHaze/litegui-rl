...
if __name__ == '__main__':
    ...
    **NOTE**: This is a frequently asked question.
    ...
    # ClawGUI's README prepares Geometry3K with save_to_disk().  Support that
    # format directly while preserving load_dataset() for Hub IDs and scripts.
    if os.path.isdir(data_source) and os.path.exists(os.path.join(data_source, 'dataset_dict.json')):
